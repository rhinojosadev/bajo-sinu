...
import Cerradura from '../../assets/images/candado.png';
...
export const Home = () => {
    ...
    return (
        <>
            ...
            <div style={{backgroundColor: "#91f1ff4d"}}>
                <h1 className='text-6xl mt-5 pt-10 text-center primary-color heading'>Conjunto de datos</h1>
                <div class="grid grid-cols-4 gap-4 mx-24 mt-24">
                    <div className="box-graph p-4 rounded-lg text-center shadow-md" 
                        onClick={() => {
                            navigate('calendario')
                        }}>
                        <img alt="" src={Cerradura} className='m-auto' style={ {height: '28px'}} />
                        <FontAwesomeIcon icon={faCalendar} fontSize={140}  className='mt-5' />
                        <p>Calendario Estacional </p>
                    </div>
                    <div className="box-graph p-4 rounded-lg text-center shadow-md" 
                     onClick={() => {
                        navigate('grafica')
                        ...
                        <img alt="" src={Cerradura} className='m-auto' style={ {height: '28px'}} />
                        <FontAwesomeIcon icon={faChartBar}  fontSize={140} className='mt-5'  />
                        <p>Estadisticas</p>
                    </div>
                    <div className="box-graph p-4 rounded-lg text-center shadow-md">
                        <img alt="" src={Cerradura}  className='m-auto' style={ {height: '28px'}} />
                        <FontAwesomeIcon icon={faChartLine}  fontSize={140} className='mt-5' />
                        <p>Linea de Tiempo</p>
                    </div>
                    <div className="box-graph p-4 rounded-lg text-center shadow-md">
                        <img alt="" src={Cerradura} className='m-auto' style={ {height: '28px'}} />
                        <FontAwesomeIcon icon={faTable}  fontSize={140} className='mt-5' />
                        <p>Producción agricola</p>
                    </div>
                </div>
